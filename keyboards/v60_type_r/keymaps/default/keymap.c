...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {    /* Keymap 0: Default Layer
     ...
     * |-----------------------------------------------------------|
     * |Ctrl|Gui |Alt |      Space/L3           |Alt |Gui |Ctrl|Fn1|
     * `-----------------------------------------------------------'
     */
    [0] = KEYMAP(
        ...
        KC_LCTL,            KC_LGUI, KC_LALT,                            LT(2, KC_SPC),                                 KC_RALT, KC_RGUI,   KC_FN1,                 KC_RCTL     ),
    /* Keymap 1: FN Layer
     * ,-----------------------------------------------------------.
     * |`  | F1| F2| F3| F4| F5| F6| F7| F8| F9|F10|F11|F12|  Del  |
     * |-----------------------------------------------------------|
     * |     |   |   |   |   |   |Cal|PgU| Up|PgD|PSc|   |   | Ins |
     * |-----------------------------------------------------------|
     * |      |   |   |   |   |   |Hom| Lt| Dn| Rt|   |   |        |
     * |-----------------------------------------------------------|
     * |        |   |   |   |   |   |End|Mut|VDn|Vup|   |          |
    ...
    [1] = KEYMAP(
        ...
        _____,   _____,   _____,   _____,   _____,   _____,   KC_CALC,  KC_PGUP,  KC_UP,    KC_PGDN,  KC_PSCR,  _____,      _____,              KC_INS,  \
        _____,   _____,   _____,   _____,   _____,   _____,   KC_HOME,  KC_LEFT,  KC_DOWN,  KC_RGHT,  _____,    _____,                          _____,  \
        _____,   _____,   _____,   _____,   _____,   _____,   _____,    KC_END,   KC_MUTE,  KC_VOLD,  KC_VOLU,  _____,                  _____,  _____,  \
